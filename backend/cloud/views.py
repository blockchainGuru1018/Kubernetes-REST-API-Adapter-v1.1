...
from .tasks import demo_task, subscription_task
import time
import uuid
import random
import socket
        ...
        try:
            ...
            for subscription_id in subscription_ids:
                ...
                for server_id in server_idstrs:
                    ...
                    # Create PVC
                    payload = "{\r\n\"kind\":\"PersistentVolumeClaim\",\r\n\"apiVersion\":\"v1\",\r\n\"metadata\":{\r\n\"name\": \"karel-claim-" + str(server_id) + "\",\r\n\"annotations\":{\r\n\"volume.beta.kubernetes.io/storage-class\": \"thin-disk\"\r\n}\r\n},\r\n\"spec\": {\r\n\"accessModes\":[\r\n\"ReadWriteOnce\"\r\n],\r\n\"resources\": {\r\n\"requests\": {\r\n\"storage\": \"1Gi\"\r\n}\r\n}\r\n}\r\n}"
                    ...
                    # Create Deployment
                    payload = "{\r\n\"apiVersion\":\"apps/v1\",\r\n\"kind\":\"Deployment\",\r\n\"metadata\":{\r\n\"name\":\"karel-deployment-" + str(server_id) + "\"\r\n},\r\n\"spec\":{\r\n\"selector\":{\r\n\"matchLabels\":{\r\n\"app\": \"karel-deployment-" + str(server_id) + "\"\r\n}\r\n},\r\n\"replicas\":1,\r\n\"template\":{\r\n\"metadata\":{\r\n\"labels\":{\r\n\"app\": \"karel-deployment-" + str(server_id) + "\"\r\n}\r\n},\r\n\"spec\": {\r\n\"containers\": [\r\n{\r\n\"name\": \"karel-deployment-" + str(server_id) + "\",\r\n\"image\":\"thenextgeneration/ipg-server:v2\",\r\n\"resources\": {\r\n\"limits\": {\r\n\"memory\": \"600Mi\",\r\n\"cpu\": 1\r\n},\r\n\"requests\": {\r\n\"memory\": \"300Mi\",\r\n\"cpu\": \"500m\"\r\n}\r\n},\r\n\"securityContext\": {\r\n\"privileged\": true\r\n},\r\n\"volumeMounts\": [\r\n{\r\n\"name\": \"karel-master-" + str(server_id) + "\",\r\n\"mountPath\": \"/karel/home/data\"\r\n}\r\n]\r\n}\r\n],\r\n\"volumes\": [\r\n{\r\n\"name\": \"karel-master-" + str(server_id) + "\",\r\n\"persistentVolumeClaim\": {\r\n\"claimName\": \"karel-claim-" + str(server_id) + "\"\r\n}\r\n}\r\n]\r\n}\r\n}\r\n}\r\n}"
                    headers = {'Content-type': 'application/json',
                               'authorization': 'bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IiJ9..WuCzioQAqzUkeVH-NwjRPZk1usasVfCc3MS9W7sKVF7hYefmCM4PP1dGfIxeA9qVwDrg5Tmm9hzzqKTWym1sbUzlxvYUi0jac-cjWD9k8_g3IF7bW00b7w2jjJ3k5f0ogZyy4aGr0HLhJswencfElE-yOqTtB6AxWc-SReJ2Diq_M-LepUK5iEi9x7JXigBZ2JPa-PpYvDyG6167s9JJdklzHSNQIKV1i81qYyrkmSCqEbnerOU8EzaphCfibOsyyrJxqI_nbB-zoUscsbb8SPMnUozy6NonvOaO-8EZfQ_lyeLmB6KNMUwUFVLxHNUaFZs-R1LYztM8A5HVeD6dkw'}
                    ...
                    payload = "{\n\t\"subscription\": \"" + str(server_object.subscription.subscription) + "\",\n\t\"service\": \"Ipg\",\n\t\"servers\": {\n\t\t\"IpgServer\": {\n\t\t\t\"cpu\": \"1\",\n\t\t\t\"ram\": \"600Mi\",\n\t\t\t\"disc\": \"2Gi\",\n\t\t\t\"widea_address\": \"www.kareldeployment.com/" + str(IpgServer_server_id) + "/widea\",\n\t\t\t\"local_ip\": \"" + str(clusterip) + "\",\n\t\t\t\"internal_ip\": \"" + str(ip_address) + ":" + str(port) + "/widea\",\n\t\t\t\"external_ip\": \"" + str(ip_address) + ":" + str(port) + "/widea\",\n\t\t\t\"server_name\": \"karel-deployment-" + str(IpgServer_server_id) + "\",\n\t\t\t\"server_id\": \"" + str(IpgServer_server_id) + "\",\n\t\t\t\"state\": \"1\",\n\t\t\t\"fqdn\": \"www.kareldeployment.com/" + str(IpgServer_server_id) + "/widea\"\n\t\t},\n\t\t\"WebcmServer\": {\n\t\t\t\"address\": \"www.kareldeployment.com/" + str(WebcmServer_server_id) + "/widea\",\n\t\t\t\"local_ip\": \"" + str(clusterip) + "\",\n\t\t\t\"internal_ip\": \"" + str(ip_address) + ":" + str(port) + "/widea\",\n\t\t\t\"server_name\": \"karel-deployment-" + str(WebcmServer_server_id) + "\",\n\t\t\t\"server_id\": \"" + str(WebcmServer_server_id) + "\",\n\t\t\t\"state\": \"1\",\n\t\t\t\"fqdn\": \"www.kareldeployment.com/" + str(WebcmServer_server_id) + "/widea\"\n\t\t}\n\t}\n}"
...
def _post_tasks(request):
    if subscription_status:
        subscription_task(subscription_ids)
